                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                    class="underline text-gray-900 dark:text-white">Nama </a></div>
                        </div>
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                <ol>
                                    <li><div><a href="/profileETS">Profile ETS</a></div></li>
                                    <li><div><a href="/linktree">Linktree</a></div></li>
                                    <li><div><a href="/latihan1">Latihan 1</a></div></li>
                                    <li><div><a href="/cobaJS">Coba JS</a></div></li>
                                    <li><div><a href="/cobaJS2">Coba JS 2</a></div></li>
                                    <li><div><a href="/style">Style</a></div></li>
                                    <li><div><a href="/introHTML">Introduction to HTML</a></div></li>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="/linktree"
                                    class="underline text-gray-900 dark:text-white">Linktree</a></div>
                        </div>

...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/linktree/StyleForLinktree.css')}}">
    <title>Kiyo Gelato & Coffee | Instagram | Linktree</title>
    <link rel="icon" type="image/x-icon" href="{{asset('assets/linktree/iconlinktree.svg')}}">
...
<body>
    <img class="profile_picture"
        src="{{asset('assets/linktree/profpiclinktree.jpeg')}}">

    <div class="profile_name">
        Kiyo Gelato & Coffee
    </div>
    <div class="underprofile_name" style="padding-bottom: 20px;">
        Come and join us down the rabbit hole!
    </div>

    <a target="_blank" href="https://instagram.com/kiyogelato" class="socmedIG" style="text-decoration: none; font-size: x-large; padding-right: 5px;">
        <ion-icon name="logo-instagram"></ion-icon>
    </a>

    <a target="_blank" href="https://api.whatsapp.com/send?phone=6281542288889" class="socmedWA" style="text-decoration: none; font-size: x-large; padding-left: 5px;">
    ...
    <a
    target="_blank"
    href="https://anyflip.com/obehf/xeyh/"
    class="link">
        🐰Seasonal Menu 🐰
    </a>
    <br>
    <a
    target="_blank"
    href="https://anyflip.com/obehf/itrd/"
    class="link">
        ☕Drinks Menu☕
    </a>
    <br>
    <a
    target="_blank"
    href="https://anyflip.com/obehf/ngwd/"
    class="link">
        🍽️Food Menu🍽️
    </a>
    <div class="wd-judul">
    ...
    <a
    target="_blank"
    href="https://www.google.com/maps/place/Kiyo+Gelato+%26+Coffee/@-6.8794129,109.6703356,17z/data=!3m1!4b1!4m5!3m4!1s0x2e7025020c8ce9a7:0xa4f70c5fff507c5a!8m2!3d-6.8794129!4d109.6725243?hl=en-GB"
    class="link">
        📍Find Us Here📍
    </a>
    <div class="wd-judul">
    ...
    <a
    target="_blank"
    href="https://grab.onelink.me/2695613898?pid=inappsharing&c=6-C22BKAE3JLBXUE&is_retargeting=true&af_dp=grab%3A%2F%2Fopen%3FscreenType%3DGRABFOOD%26sourceID%3DA4pcqCZkS4%26merchantIDs%3D6-C22BKAE3JLBXUE&af_force_deeplink=true&af_web_dp=https%3A%2F%2Fwww.grab.com"
    class="link">
        🛵Grabfood🛵
    </a>
    <br>
    <a
    target="_blank"
    href="https://shopee.co.id/universal-link/now-food/shop/20335970?deep_and_deferred=1&share"
    class="link">
        🛵Shopeefood🛵
    </a>
    <br>
